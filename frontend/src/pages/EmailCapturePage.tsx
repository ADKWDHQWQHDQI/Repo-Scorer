...
export function EmailCapturePage() {
  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4 pt-2 pb-4">
      <div className="max-w-xl w-full">
        {/* Header Section */}
        <div className="text-center mb-5">
          <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-gradient-to-br from-blue-600 to-indigo-700 mb-3 shadow-md">
            <Sparkles className="w-6 h-6 text-white" />
          </div>
          <h1 className="text-2xl font-bold bg-gradient-to-r from-blue-900 via-blue-700 to-indigo-700 bg-clip-text text-transparent mb-2">
            One Final Step
          </h1>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`block w-full pl-10 pr-4 py-3 text-base border rounded-lg focus:outline-none focus:ring-2 transition-all ${
                    !isValid
